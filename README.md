...
```sh
export HOMEBREW_GITHUB_API_TOKEN=…   # or `gh auth login`
brew tap odrinateur/tap
brew install --cask odrinateur/tap/tinycast
```
...
`xattr -dr com.apple.quarantine "/Applications/Tinycast.app"` once.
