enum SettingsTab: CaseIterable, Identifiable {
    case general, applications, systemSettings, systemActions, commands, quicklinks, fallbacks,
        fileSearch, notes, snippets, navigation, windowManagement, clipboard, emoji,
