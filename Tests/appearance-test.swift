...
struct AppearanceTests {
    ...
    static func main() {
        ...
        // Flat and solid in both: the popover fill covers panel content with no glass.
        check("popSurface stays solid dark", components(c.popSurface, .darkAqua)[3] == 255)
        check("popSurface stays solid light", components(c.popSurface, .aqua)[3] == 255)
